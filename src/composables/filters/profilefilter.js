...
const useAssetFilter = () => {
  ...
  function _thisFiltering(rows, terms) {
    ...
    const filteredRows = rows.filter((row, i) => {
      ...
      if (_cat == "Machinery") {
        _group0 = terms.Machines;
      } else if (_cat == "Consumable") {
        _group0 = terms.Consumable;
      } else if (_cat == "Accessory") {
        _group0 = terms.Acce;
      } else if (_cat == "Tools") {
        _group0 = terms.Tools;
      } else if (_cat == "Spares") {
        _group0 = terms.Spares;
      } else if (_cat == "Sanitary") {
        _group0 = terms.Sanitary;
      } else if (_cat == "RaWMatterial") {
        _group0 = terms.Raws;
      }
