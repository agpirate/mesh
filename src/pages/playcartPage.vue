<template>
  ...
  <q-page class="row rounded-borders fontastyle q-py-xs fit boxastyle">
    ...
    <div
      class="col-grow column rounded-borders fontastyle q-gutter-xs boxbstyle"
      style="height: 93svh"
    >
      <!---Quantity Tags-->
      <div
      ...
      <div class="col column q-pa-sm q-ma-none">
        ...
        >
          <q-table
            ...
            row-key="id"
            rowIndex="true"
            style="background-color: whitesmoke; backdrop-filter: blur(750px)"
            hide-pagination
            hide-top
            hide-bottom
          >
            <template #header-cell="props">
              ...
              >
                <div
                  class="justify-center row fontastyle bg-orange"
                  style="backdrop-filter: blur(850px)"
                >
                  <p>{{ props.col.name }}</p>
                </div>
              </q-td>
            ...
            <template v-slot:body="props">
              ...
              >
                <td
                  ...
                  class="text-bold text-start fontastyle"
                ...
                >
                  ...
                  <div v-else-if="object.name == 'store'">
                    ...
                    >
                      Ordered</q-badge
                    >
                    <q-badge color="teal" v-else>Saved</q-badge>
                  </div>
    ...
    >
      ...
      <div>
        <q-img
          ...
          style="max-width: 90%; border-radius: 5px; aspect-ratio: 2/1"
        >
        </q-img>
      </div>

      <div class="row q-gutter-sm">
        <q-item class="col-auto column q-gutter-sm">
          <div
            class="col-auto row justify-start"
            style="height: 40px; top: 0px; right: 0px"
