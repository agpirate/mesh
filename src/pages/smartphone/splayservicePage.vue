<template>
  ...
  <!-- <dialogOne :isOpen="__this_foreignBoxsubOps == 'view'" @emitClick0="__this_foreignBoxsubOps = $event">
  ...
  <q-page class="row no-wrap rounded-borders fit bg-white">
    <div
      class="col q-gutter-xs column no-wrap boxastyle q-px-xs"
      style="min-width: 95vw; height: 88vh"
    >
      <div class="col column q-gutter-xs" style="max-height: 90vh">
        <div class="col-auto q-pa-sm fontestyle column">
          <div class="row q-mx-xs"><div>Your Service and Products</div></div>

          <div
            class="items-center fontastyle text-blue row justify-between col-auto"
            v-if="_this_Rows?.length ?? true"
          >
            <div class="items-center q-px-xs">
    ...
    <div
      class="col column rounded-borders fontastyle q-gutter-xs bg-orange"
      style="min-height: 90svh; min-width: 98vw"
    >
      <!---Quantity Tags-->
      <div class="column q-gutter-xs q-ma-none">
        ...
        <div
          class="col-auto q-gutter-sm row no-wrap q-pa-xs justify-between"
        ...
        >
          ...
          <div class="col q-gutter-xs row q-pa-none">
            <q-card-section
              class="shadow-1 col-auto box0style q-gutter-xs column"
            >
              <div class="box0style">Total Orders</div>
            ...
            <!---Price Tags-->
            <div class="shadow-1 col-auto box0style column">
              <div class="box0style">Expected Income</div>

              <div class="row flex flex-center col-grow q-gutter-xs">
                <div class="circleaStyle">{{ totalPrice }}</div>
                <div class="">{{ _this.currency ?? "" }}</div>
              </div>
            </div>

            <div
              class="col q-gutter-xs items-center column justify-center fontcstyle text-white row q-pa-none"
            >
              <q-icon name="link" class="" />
            </div>
          </div>
        </div>
      </div>
          ...
          >
            ...
            <template v-slot:body="props">
              <q-tr :props="props">
                ...
                >
                  <!-----editng Serve status-->
                  <div class="col-auto row justify-start q-gutter-xs">
                    <div class="q-px-md">
                      <p>Editing Order</p>
                      <div>
                        <q-icon
                ...
                <td
                  v-else
                  :props="props"
                  style="font-size: 0.6em; text-align: justify; padding: 0px"
                  class="text-center"
                  :class="
                ...
                >
                  <!--Styling Tabs-->
                  <div v-if="object.name == 'served'" class="">
                    <div
                      :style="
                  ...
                  <div v-else-if="object.name == 'description'">
                    ...
                    <q-card
                      ...
                      class="fixed-bottom z-top flex flex-center"
                  ...
                  <div v-else-if="object.name == 'time'" class="text-grey">
                    <div>
