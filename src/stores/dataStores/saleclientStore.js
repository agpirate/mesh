...
const API_URL = process.env.API_IP_PORT+"/saleclientapi"; //const API_URL = `${import.meta.env.API_URL}/users`;
...
const _suburl="/saleclient"
const STORE_NAME ="saleclientStore";
...
export const saleclientStore = defineStore(STORE_NAME, () => {
  //state
  let Datas = ref([]); //
  let status_Rows = ref('');
