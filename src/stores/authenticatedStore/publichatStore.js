...
const STORE_NAME ="publichatStore";
...
async function asyncDatas ()  { 
       ...
       //console.log('searching.......')
        ...
        DatasDebuger.value=true
        try {
          return await modalApi.get(API_URL+"/publicchat",requestOptions).then((response)=>{
            ...
            return true
          }).catch((error)=>{DatasDebuger.value=false;//Datas.value =[]
            return true}) 
        } catch (error) {    }
        return true
  };
