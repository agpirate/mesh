 ...
 export const rOp = async function (dbModel,findBy=[],returnWat={},limits=100,sortBy={updatedAt:-1 }) {
    try {
      return await dbModel
  ...
  export const rOrp = async function (dbModel,findBy=[],returnWat={},limits=100,sortBy={updatedAt:-1 }) {
    try {
      return await dbModel
        .find({ $or: findBy }, returnWat)
        .sort(sortBy)
